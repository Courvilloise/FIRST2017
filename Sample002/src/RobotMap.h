...
public:
	...
	static std::shared_ptr<SpeedController> engrenageMoteur;
	static std::shared_ptr<DigitalInput> engrenageLimitSwitchFermeture;
	static std::shared_ptr<DigitalInput> engrenageLimitSwitchOuverture;
#endif
