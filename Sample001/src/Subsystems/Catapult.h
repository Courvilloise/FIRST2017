...
private:
	...
	std::shared_ptr<SpeedController> pMW4AgitatorEngine;
	std::shared_ptr<CANTalon> cAN1ThrowEngine;

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS

	double currentBallSpeed; 		// Used to store the current ball speed
	double currentAgitatorSpeed;	// Used to store the current agitator speed
...
public:
	...
	void SetRotationSpeed(double ballSpeed, double agitatorSpeed = CATAPULT_AGITATOR_SPEED);
	...
	double GetCurrentBallSpeed(){return currentBallSpeed;}
