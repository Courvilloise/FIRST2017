...
std::shared_ptr<SpeedController> RobotMap::geargatePMW7GateEngine;
...
void RobotMap::init() {
    ...
    geargatePMW7GateEngine.reset(new VictorSP(4));
    lw->AddActuator("Geargate", "PMW7GateEngine", std::static_pointer_cast<VictorSP>(geargatePMW7GateEngine));
